 ...
 */
/* ADOVRF_Mn */
#define ADxREGn_ADOVR_Mn_MASK      ((uint32_t)0x20000000)    /*!< ADOVR_Mn :Mask          */
#define ADxREGn_ADOVR_Mn_OFF       ((uint32_t)0x00000000)    /*!< ADOVR_Mn :Flag off.     */
#define ADxREGn_ADOVR_Mn_ON        ((uint32_t)0x20000000)    /*!< ADOVR_Mn :Flag on       */
/* ADRF_Mn   */
