...
#define CG_PRCK_2        ((uint32_t)0x01000000)    /*!< CG ƒÓT0 fc/2 register value */
#define CG_PRCK_4        ((uint32_t)0x02000000)    /*!< CG ƒÓT0 fc/4 register value */
#define CG_PRCK_8        ((uint32_t)0x03000000)    /*!< CG ƒÓT0 fc/8 register value */
#define CG_PRCK_16       ((uint32_t)0x04000000)    /*!< CG ƒÓT0 fc/16 register value */
#define CG_PRCK_32       ((uint32_t)0x05000000)    /*!< CG ƒÓT0 fc/32 register value */
#define CG_PRCK_64       ((uint32_t)0x06000000)    /*!< CG ƒÓT0 fc/64 register value */
#define CG_PRCK_128      ((uint32_t)0x07000000)    /*!< CG ƒÓT0 fc/128 register value */
#define CG_PRCK_256      ((uint32_t)0x08000000)    /*!< CG ƒÓT0 fc/256 register value */
#define CG_PRCK_512      ((uint32_t)0x09000000)    /*!< CG ƒÓT0 fc/512 register value */
...
uint32_t cg_get_phyt0(cg_t *p_obj)
{
    ...
    {
    case CG_PRCK_1:             /* ƒÓT0 -> fc */
        result /= CG_PRCK_1_DIV;
        break;
    case CG_PRCK_2:             /* ƒÓT0 -> fc/2 */
        result /= CG_PRCK_2_DIV;
        break;
    case CG_PRCK_4:             /* ƒÓT0 -> fc/4 */
        result /= CG_PRCK_4_DIV;
        break;
    case CG_PRCK_8:             /* ƒÓT0 -> fc/8 */
        result /= CG_PRCK_8_DIV;
        break;
    case CG_PRCK_16:            /* ƒÓT0 -> fc/16 */
        result /= CG_PRCK_16_DIV;
        break;
    case CG_PRCK_32:            /* ƒÓT0 -> fc/32 */
        result /= CG_PRCK_32_DIV;
        break;
    case CG_PRCK_64:            /* ƒÓT0 -> fc/64 */
        result /= CG_PRCK_64_DIV;
        break;
    case CG_PRCK_128:           /* ƒÓT0 -> fc/128 */
        result /= CG_PRCK_128_DIV;
        break;
    case CG_PRCK_256:           /* ƒÓT0 -> fc/256 */
        result /= CG_PRCK_256_DIV;
        break;
    case CG_PRCK_512:           /* ƒÓT0 -> fc/512 */
